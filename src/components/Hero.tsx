...
/** Hero backdrop — a Ducati Panigale V4 under tunnel lighting. */
const HERO_IMAGE =
  "https://images.unsplash.com/photo-1615172282427-9a57ef2d142e?q=85&w=2400&auto=format&fit=crop";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 z-10 bg-linear-to-b from-dark/80 via-dark/50 to-dark" />
      </div>
